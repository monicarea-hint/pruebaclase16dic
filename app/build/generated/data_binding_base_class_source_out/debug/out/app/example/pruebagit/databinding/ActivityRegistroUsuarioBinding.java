...
public final class ActivityRegistroUsuarioBinding implements ViewBinding {
  ...
  private ActivityRegistroUsuarioBinding(@NonNull LinearLayout rootView,
      @NonNull AppCompatButton btnRegistrar, @NonNull TextInputEditText cedulaUsuario,
      @NonNull ImageView imageSearch, @NonNull ImageView imageUser, @NonNull LinearLayout main,
  ...
  public static ActivityRegistroUsuarioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegistroUsuarioBinding((LinearLayout) rootView, btnRegistrar,
          cedulaUsuario, imageSearch, imageUser, main, nombreUsuario, password, saldo,
          tipoCuentaSpinner, tvTengoCuenta);
    }
