...
public final class ActivityMain2Binding implements ViewBinding {
  ...
  private ActivityMain2Binding(@NonNull LinearLayout rootView, @NonNull Button btnCuenta,
      @NonNull AppCompatButton btnDividir, @NonNull AppCompatButton btnMultiplicar,
      @NonNull AppCompatButton btnRestar, @NonNull AppCompatButton btnSumar,
      @NonNull EditText etNum1, @NonNull EditText etNum2, @NonNull LinearLayout main,
      @NonNull TextView tvMostrarRespuesta) {
  ...
  public static ActivityMain2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMain2Binding((LinearLayout) rootView, btnCuenta, btnDividir,
          btnMultiplicar, btnRestar, btnSumar, etNum1, etNum2, main, tvMostrarRespuesta);
    }
